    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Categories",
                columns: new[] { "Id", "Icon", "IsDefault", "Name" },
                values: new object[,]
                {
                    { 1, "restaurant", true, "Food" },
                    { 2, "directions_car", true, "Transport" },
                    { 3, "shopping_bag", true, "Shopping" },
                    { 4, "receipt_long", true, "Bills" },
                    { 5, "movie", true, "Entertainment" },
                    { 6, "favorite", true, "Health" },
                    { 7, "category", true, "Other" }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Expenses_BoardId_Date",
                table: "Expenses",
                columns: new[] { "BoardId", "Date" });
